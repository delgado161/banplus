...
<div style="background-color:#F4F4F4;overflow:auto;overflow-x:hidden;" class="form_n" > 
    ...
    <div style="float:left;padding:5px;">
        ...
        <input onkeypress="return solo_letras2(event)" type="text" name="n_documento" id="n_documento" value="">
    </div>
    <!--    <div style="float:left;padding:5px;">
    ...
    <div style="float:left;width:23,5%;padding:5px;">
        ...
        <input onkeypress="return solo_letras(event)" type="text" name="p_nombre" id="p_nombre" value="">
    </div>
    <div style="float:left;width:23,5%;padding:5px;">
        <label for="s_nombre">Segundo Nombre:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" type="text" name="s_nombre" id="s_nombre" value="">
    </div>
    <div style="float:left;width:23,5%;padding:5px;">
        <label for="p_apellido">Primer Apellido:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" type="text" name="p_apellido" id="p_apellido" value="">
    </div>
    <div style="float:left;width:23,5%;padding:5px;">
        <label for="s_apellido">Segundo Apellido:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" type="text" name="s_apellido" id="s_apellido" value="">
    </div>
    ...
    <div style="float:left;padding:5px;">
        ...
        <select name="tp_civil" id="tp_civil">
    ...
    <div style="float:left;padding:5px;">
        ...
        <input style="width:110px;" type="text" name="fc_nac" id="fc_nac" value="">
    </div>

    <div style="float:left;padding:5px;">
        <label for="edad">Edad:<span style="color:red">*</span></label><br>
        <input style="width:40px;" type="text" name="edad" id="edad" value="" readonly>
    </div>

    <div style="float:left;padding:5px;">
        <label for="g_familiar">N&uacute;mero de grupo familiar:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_numeros(event)" style="width:120px;" type="number" name="g_familiar" id="g_familiar" min="1" max="100">
    </div>
    ...
    <div style="float:left;padding:5px;width:31.5%;">
        ...
        <select name="tp_pais" id="tp_pais" style="width:100%">
            <option value="">Seleccione...
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select name="tp_estado" id="tp_estado" style="width:100%;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select name="tp_ciudad" id="tp_ciudad" style="width:100%;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>
    ...
    <div style="float:left;width:30%;padding:5px;">
        ...
        <select name="tp_profecion" id="tp_profecion" style="width:100%;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>
    ...
    <div style="float:left;width:30%;padding:5px;">
        ...
        <select name="tp_ocupacion" id="tp_ocupacion" style="width:100%;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>
    ...
    <div style="float:left;padding:5px;">
        ...
        <input onkeypress="return solo_email(event)" type="text" name="email" id="email" value="" style="width:260px;">
    </div>
    ...
    <div style="float:left;width:23,5%;padding:5px;">
        ...
        <input onkeypress="return solo_letras(event)" type="text" name="cp_nombre" id="cp_nombre" value="">
    </div>
    <div style="float:left;width:23,5%;padding:5px;">
        <label for="cs_nombre">Segundo Nombre:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" type="text" name="cs_nombre" id="cs_nombre" value="">
    </div>
    <div style="float:left;width:23,5%;padding:5px;">
        <label for="cp_apellido">Primer Apellido:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" type="text" name="cp_apellido" id="cp_apellido" value="">
    </div>
    <div style="float:left;width:23,5%;padding:5px;">
        <label for="cs_apellido">Segundo Apellido:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" type="text" name="cs_apellido" id="cs_apellido" value="">
    </div>
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select class="_estados" name="ctp_estado" id="ctp_estado" style="width:100%;">
            <option value="">Seleccione...
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select name="ctp_ciudad" id="ctp_ciudad" style="width:100%;">
            <option value="">Seleccione...
        </select>
    </div>
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <input onkeypress="return solo_letras2(event)" style="width:236px;" type="text" name="c_calle" id="c_calle" value="" >
    </div>
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select class="_estados" name="dtp_estado" id="dtp_estado" style="width:100%;">
            <option value="">Seleccione...
                <?php echo $_opc_estados; ?>
        </select>
    </div>
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select name="dtp_ciudad" id="dtp_ciudad" style="width:100%;">
            <option value="">Seleccione...
        </select>
    </div>
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <input onkeypress="return solo_letras2(event)" style="width:236px;" type="text" name="d_calle" id="d_calle" value="" >
    </div>

    <div style="width:100%; margin-top:10px;float:left;"></div>
    <div style="float:left;width:31.5%;padding:5px;">
        <label for="d_urbanizacion">Urbanizaci&oacute;n:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras2(event)" style="width:236px;" type="text" name="d_urbanizacion" id="d_urbanizacion" value="" >
    </div>
    <div style="float:left;padding:5px;">
        <label for="d_apartamento">Apartamento:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras2(event)" style="width:65px;" type="text" name="d_apartamento" id="d_apartamento" value="">
    </div>
    <div style="float:left;padding:5px;">
        <label for="d_piso">Piso:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras2(event)" style="width:40px;" type="text" name="d_piso" id="d_piso" value="" >
    </div>

    <div style="float:left;padding:5px;">
        <label for="tp_inmueble">Tipo inmueble:<span style="color:red">*</span></label><br>
        <select name="tp_inmueble" id="tp_inmueble" style="width:200px;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>
    ...
    <div style="float:left;padding:5px;">
        ...
        <input onkeypress="return solo_numeros(event)" style="width:100px;" type="number" name="ano_vivienda" id="ano_vivienda" min="1" max="2000">
    </div>
    <div style="width:100%; margin-top:10px;float:left;"></div>
    <div style="float:left;padding:5px;">
        <label for="dtp_telefono">Tel&eacute;fono:<span style="color:red">*</span></label><br>
        <select name="dtp_telefono" id="dtp_telefono" style="width:70px;">
            <option value="C">0212
            <option value="p">Casado
            <option value="p">Viudo
        </select>
        <input onkeypress="return solo_numeros(event)" style="width:100px;" type="text" name="d_telefono" id="d_telefono" value="">
    </div>
    ...
    <div style="float:left;padding:5px;">
        ...
        <input onkeypress="return solo_letras3(event)" style="width:236px;" type="text" name="n_empresa" id="n_empresa" value="" >
    </div>
    <div style="float:left;padding:5px;">
        <label for="ramo_empresa">Actividad o ramo:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" style="width:236px;" type="text" name="ramo_empresa" id="ramo_empresa" value="" >
    </div>
    <div style="float:left;padding:5px;">
        <label for="cargo_empresa">Cargo:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" style="width:236px;" type="text" name="cargo_empresa" id="cargo_empresa" value="" >
    </div>
    ...
    <div style="float:left;padding:5px;">
        ...
        <select name="etp_relacion" id="etp_relacion" style="width:186px;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>
    ...
    <div style="float:left;padding:5px;">
        ...
        <input onkeypress="return solo_letras2(event)" style="width:65px" type="text" name="e_antiguo" id="e_antiguo" value="" >
    </div>
    ...
    <div style="float:left;padding:5px;">
        ...
        <input onkeypress="return solo_moneda(event)" style="width:155px" type="text" name="sueldo" id="sueldo" value="" >Bs.
    </div>
    <div style="float:left;padding:5px;">
        <label for="comision">Bonificaci&oacute;n o comisiones:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_moneda(event)" style="width:155px" type="text" name="comision" id="comision" value="" >Bs.
    </div>
    <div style="float:left;padding:5px;">
        <label for="libre_ejercicio">Libre ejercicio de la profesi&oacute;n:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_moneda(event)" style="width:155px" type="text" name="libre_ejercicio" id="libre_ejercicio" value="" >Bs.
    </div>
    <div style="float:left;padding:5px;">
        <label for="otros_ingresos">Otros ingresos:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_moneda(event)" style="width:155px" type="text" name="otros_ingresos" id="otros_ingresos" value="" >Bs.
    </div>
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select class="_estados" name="etp_estado" id="etp_estado" style="width:100%;">
            <option value="">Seleccione...
                <?php echo $_opc_estados; ?>
        </select>
    </div>
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select name="etp_ciudad" id="etp_ciudad" style="width:100%;">
            <option value="">Seleccione...
        </select>
    </div>
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <input onkeypress="return solo_letras2(event)" style="width:236px;" type="text" name="e_calle" id="e_calle" value="" >
    </div>
    <div style="width:100%; margin-top:10px;float:left;"></div>
    <div style="float:left;width:31.5%;padding:5px;">
        <label for="e_urbanizacion">Urbanizaci&oacute;n:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras2(event)" style="width:236px;" type="text" name="e_urbanizacion" id="e_urbanizacion" value="" >
    </div>
    <div style="float:left;padding:5px;">
        <label for="e_apartamento">Apartamento:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras2(event)" style="width:65px;" type="text" name="e_apartamento" id="e_apartamento" value="">
    </div>
    <div style="float:left;padding:5px;">
        <label for="e_piso">Piso:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras2(event)" style="width:40px;" type="text" name="e_piso" id="e_piso" value="" >
    </div>

    <div style="float:left;padding:5px;">
        <label for="edctp_telefono">Tel&eacute;fono:</label><br>
        <select name="edctp_telefono" id="edctp_telefono" style="width:70px;">
            <option value="C">0212
            <option value="p">Casado
            <option value="p">Viudo
        </select>
    ...
    <div style="float:left;width:30%;padding:5px;">
        ...
        <select name="rtp_ocupacion" id="rtp_ocupacion" style="width:100%;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>
    ...
    <div style="float:left;width:23,5%;padding:5px;">
        ...
        <input onkeypress="return solo_letras(event)" type="text" name="rp_nombre" id="rp_nombre" value="">
    </div>
    <div style="float:left;width:23,5%;padding:5px;">
        <label for="rs_nombre">Segundo Nombre:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" type="text" name="rs_nombre" id="rs_nombre" value="">
    </div>
    <div style="float:left;width:23,5%;padding:5px;">
        <label for="rp_apellido">Primer Apellido:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" type="text" name="rp_apellido" id="rp_apellido" value="">
    </div>
    <div style="float:left;width:23,5%;padding:5px;">
        <label for="rs_apellido">Segundo Apellido:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras(event)" type="text" name="rs_apellido" id="rs_apellido" value="">
    </div>
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select class="_estados" name="rdtp_estado" id="rdtp_estado" style="width:100%;">
            <option value="">Seleccione...
                <?php echo $_opc_estados; ?>
        </select>
    </div>
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <select name="rdtp_ciudad" id="rdtp_ciudad" style="width:100%;">
            <option value="">Seleccione...
        </select>
    </div>
    ...
    <div style="float:left;width:31.5%;padding:5px;">
        ...
        <input onkeypress="return solo_letras2(event)" style="width:236px;" type="text" name="r_calle" id="r_calle" value="" >
    </div>

    <div style="width:100%; margin-top:10px;float:left;"></div>
    <div style="float:left;width:31.5%;padding:5px;">
        <label for="r_urbanizacion">Urbanizaci&oacute;n:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras2(event)" style="width:236px;" type="text" name="r_urbanizacion" id="r_urbanizacion" value="" >
    </div>
    <div style="float:left;padding:5px;">
        <label for="r_apartamento">Apartamento:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras2(event)" style="width:65px;" type="text" name="r_apartamento" id="r_apartamento" value="">
    </div>
    <div style="float:left;padding:5px;">
        <label for="r_piso">Piso:<span style="color:red">*</span></label><br>
        <input onkeypress="return solo_letras2(event)" style="width:40px;" type="text" name="r_piso" id="r_piso" value="" >
    </div>

    <div style="float:left;padding:5px;">
        <label for="rtp_telefono">Tel&eacute;fono:</label><br>
        <select name="rtp_telefono" id="rtp_telefono" style="width:70px;">
            <option value="C">0212
            <option value="p">Casado
            <option value="p">Viudo
        </select>
        <input onkeypress="return solo_numeros(event)" style="width:100px;" type="text" name="r_telefono" id="r_telefono" value="">
    </div>
    ...
    <div style="float:left;padding:5px;">
        ...
        <select name="tp_banco" id="tp_banco" style="width:246px;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>    
    ...
    <div style="float:left;padding:5px;">
        ...
        <input onkeypress="return solo_numeros(event)" style="width:236px;" type="text" name="cuenta" id="cuenta" value="" >
    </div>
    <div style="float:left;padding:5px;">
        <label for="tp_cuenta">Tipo de cuenta:<span style="color:red">*</span></label><br>
        <select name="tp_cuenta" id="tp_cuenta" style="width:145px;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>    
    ...
    <div style="float:left;padding:5px;">
        ...
        <input onkeypress="return solo_letras2(event)" style="width:65px" type="text" name="cuenta_antiguo" id="cuenta_antiguo" value="" >
    </div>

    <div style="width:100%; margin-top:10px;float:left;"></div>
    <div style="float:left;padding:5px;">
        <label for="tp_agencia">Agencia:<span style="color:red">*</span></label><br>
        <select name="tp_agencia" id="tp_agencia" style="width:246px;">
            <option value="">Seleccione...
                <?php
    ...
    <div style="float:left;padding:5px;">
        ...
        <select name="tp_producto" id="tp_producto" style="width:145px;">
            <option value="C">Soltero
            <option value="p">Casado
            <option value="p">Viudo
        </select>    
    ...
    <div style="float:left;padding:5px;">
        ...
        <input onkeypress="return solo_numeros(event)" style="width:236px;" type="text" name="numero_bp" id="numero_bp" value="" >
    </div>
</div>
