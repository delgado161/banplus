...
function mostrarTweets(
	...
	$settings = array(
		...
		'oauth_access_token'		=> "181358561-Gs0zJS0HQkCueuaSSGFMXGUSYAIGO9IWIkCOTZY9",
		'oauth_access_token_secret'	=> "Dsl9is6wbmBenuv9lsgC3Ztk8JbaXZvgXyRhpSNBSYi0B"
	);
	...
	if(time() - $periodo_cache < $actualizado_cache) {
		...
		// Petición get (https://dev.twitter.com/docs/api/1.1/get/statuses/user_timeline) .$screen_name
		$url = 'https://api.twitter.com/1.1/statuses/user_timeline.json';
		$parametros = "?screen_name=guitarist_jose"."&count=".$nTweets."&include_rts=".$incluir_rts."&exclude_replies=".$ignorar_respuestas;
		$requestMethod = 'GET';
