...
// Create page object
$parametros_archivo_blobview = new cparametros_archivo_blobview();
$Page =& $parametros_archivo_blobview;

// Page init
$parametros_archivo_blobview->Page_Init();

// Page main
$parametros_archivo_blobview->Page_Main();
?>
<?php
$parametros_archivo_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cparametros_archivo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'parametros_archivo_blobview';
	...
	//
	function cparametros_archivo_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('parametros');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('parametros', 'x_archivo');
