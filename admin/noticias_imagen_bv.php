...
// Create page object
$noticias_imagen_blobview = new cnoticias_imagen_blobview();
$Page =& $noticias_imagen_blobview;

// Page init
$noticias_imagen_blobview->Page_Init();

// Page main
$noticias_imagen_blobview->Page_Main();
?>
<?php
$noticias_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cnoticias_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'noticias_imagen_blobview';
	...
	//
	function cnoticias_imagen_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('noticias');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('noticias', 'x_imagen');
