...
define("EW_PROJECT_NAME", "pruebabanplus", TRUE); // Project name
define("EW_RANDOM_KEY", '2r5R2Sc16SrEEM5C', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/pruebabanplus.css", TRUE); // Project stylesheet file name
...
$EW_XSS_ARRAY = array('javascript', 'vbscript', 'expression', '<applet', '<meta', '<xml', '<blink', '<link', '<style', '<script',  '<frame', '<frameset', '<ilayer', '<layer', '<bgsound', '<title', '<base',
...
define("EW_AUDIT_TRAIL_FIELD_NAME_DATETIME", "fecha", TRUE); // Audit trail DateTime field name
...
define("EW_AUDIT_TRAIL_FIELD_NAME_FIELD", "archivo", TRUE); // Audit trail Field field name
define("EW_AUDIT_TRAIL_FIELD_NAME_KEYVALUE", "valor", TRUE); // Audit trail Key Value field name
define("EW_AUDIT_TRAIL_FIELD_NAME_OLDVALUE", "valorinicial", TRUE); // Audit trail Old Value field name
define("EW_AUDIT_TRAIL_FIELD_NAME_NEWVALUE", "valorfinal", TRUE); // Audit trail New Value field name

// Security
define("EW_ADMIN_USER_NAME", "j", TRUE); // Administrator user name
...
$EW_USER_LEVEL_TABLE_NAME[] = 'agencias';
$EW_USER_LEVEL_TABLE_VAR[] = 'agencias';
$EW_USER_LEVEL_TABLE_NAME[] = 'agencias_servicios';
$EW_USER_LEVEL_TABLE_VAR[] = 'agencias_servicios';
$EW_USER_LEVEL_TABLE_NAME[] = 'banner';
$EW_USER_LEVEL_TABLE_VAR[] = 'banner';
/*$EW_USER_LEVEL_TABLE_NAME[] = 'banner_seccion';
$EW_USER_LEVEL_TABLE_VAR[] = 'banner_seccion';*/
$EW_USER_LEVEL_TABLE_NAME[] = 'bitacora';
$EW_USER_LEVEL_TABLE_VAR[] = 'bitacora';
$EW_USER_LEVEL_TABLE_NAME[] = 'calendario';
$EW_USER_LEVEL_TABLE_VAR[] = 'calendario';
$EW_USER_LEVEL_TABLE_NAME[] = 'ciudad';
$EW_USER_LEVEL_TABLE_VAR[] = 'ciudad';
/*$EW_USER_LEVEL_TABLE_NAME[] = 'comentarios';
$EW_USER_LEVEL_TABLE_VAR[] = 'comentarios';*/
$EW_USER_LEVEL_TABLE_NAME[] = 'documentos';
$EW_USER_LEVEL_TABLE_VAR[] = 'documentos';
/*$EW_USER_LEVEL_TABLE_NAME[] = 'documentos_secciones';
$EW_USER_LEVEL_TABLE_VAR[] = 'documentos_secciones';*/
$EW_USER_LEVEL_TABLE_NAME[] = 'encuesta';
$EW_USER_LEVEL_TABLE_VAR[] = 'encuesta';
$EW_USER_LEVEL_TABLE_NAME[] = 'estado';
$EW_USER_LEVEL_TABLE_VAR[] = 'estado';
$EW_USER_LEVEL_TABLE_NAME[] = 'grupo';
$EW_USER_LEVEL_TABLE_VAR[] = 'grupo';
/*$EW_USER_LEVEL_TABLE_NAME[] = 'grupo_secciones';
$EW_USER_LEVEL_TABLE_VAR[] = 'grupo_secciones';*/
$EW_USER_LEVEL_TABLE_NAME[] = 'informacion_financiera';
$EW_USER_LEVEL_TABLE_VAR[] = 'informacion_financiera';
/*$EW_USER_LEVEL_TABLE_NAME[] = 'modulos';
$EW_USER_LEVEL_TABLE_VAR[] = 'modulos';*/
$EW_USER_LEVEL_TABLE_NAME[] = 'noticias';
$EW_USER_LEVEL_TABLE_VAR[] = 'noticias';
$EW_USER_LEVEL_TABLE_NAME[] = 'parametros';
$EW_USER_LEVEL_TABLE_VAR[] = 'parametros';
/*$EW_USER_LEVEL_TABLE_NAME[] = 'preguntas';
$EW_USER_LEVEL_TABLE_VAR[] = 'preguntas';
$EW_USER_LEVEL_TABLE_NAME[] = 'respuestas';
$EW_USER_LEVEL_TABLE_VAR[] = 'respuestas';*/
$EW_USER_LEVEL_TABLE_NAME[] = 'contenidos';
$EW_USER_LEVEL_TABLE_VAR[] = 'contenidos';
$EW_USER_LEVEL_TABLE_NAME[] = 'servicios';
$EW_USER_LEVEL_TABLE_VAR[] = 'servicios';
$EW_USER_LEVEL_TABLE_NAME[] = 'usuarios';
$EW_USER_LEVEL_TABLE_VAR[] = 'usuarios';
$EW_USER_LEVEL_TABLE_NAME[] = 'menu';
$EW_USER_LEVEL_TABLE_VAR[] = 'zmenu';
/*$EW_USER_LEVEL_TABLE_NAME[] = 'view1';
$EW_USER_LEVEL_TABLE_VAR[] = 'view1';*/

$EW_USER_LEVEL_TABLE_NAME[] = 'memoria_semestral';
$EW_USER_LEVEL_TABLE_VAR[] = 'memoria_semestral';

$EW_USER_LEVEL_TABLE_NAME[] = 'promociones';
$EW_USER_LEVEL_TABLE_VAR[] = 'promociones';

$EW_USER_LEVEL_TABLE_NAME[] = 'faq';
$EW_USER_LEVEL_TABLE_VAR[] = 'faq';

$EW_USER_LEVEL_TABLE_NAME[] = 'departamentos';
$EW_USER_LEVEL_TABLE_VAR[] = 'departamentos';

$EW_USER_LEVEL_TABLE_NAME[] = 'aspiracion_salarial';
$EW_USER_LEVEL_TABLE_VAR[] = 'aspiracion_salarial';

$EW_USER_LEVEL_TABLE_NAME[] = 'nivel_academico';
$EW_USER_LEVEL_TABLE_VAR[] = 'nivel_academico';

$EW_USER_LEVEL_TABLE_NAME[] = 'tasas_interes';
$EW_USER_LEVEL_TABLE_VAR[] = 'tasas_interes';
$EW_USER_LEVEL_TABLE_NAME[] = 'cuotas';
$EW_USER_LEVEL_TABLE_VAR[] = 'cuotas';

$EW_USER_LEVEL_TABLE_CAPTION = array_fill(0, 25, ''); 

//$EW_USER_LEVEL_TABLE_CAPTION = array_fill(0, 25, ''); // Blank, use $Language object. For compatibility with PHP Report Maker 3 only.
...
@define("EW_USER_LEVEL_TABLE", "`usuarioniveles`", TRUE);
...
@define("EW_USER_LEVEL_PRIV_TABLE", "`usuariopermisos`", TRUE);
...
define("EW_USER_NAME_FILTER", "(`acceso` = '%u')",  TRUE);
...
define("EW_USER_PROFILE_RETRY_LOCKOUT", 1, TRUE);
...
define("EW_MAX_FILE_SIZE", 10000000, TRUE); // Max file size
