...
// Create page object
$modulos_plantilla_blobview = new cmodulos_plantilla_blobview();
$Page =& $modulos_plantilla_blobview;

// Page init
$modulos_plantilla_blobview->Page_Init();

// Page main
$modulos_plantilla_blobview->Page_Main();
?>
<?php
$modulos_plantilla_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cmodulos_plantilla_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'modulos_plantilla_blobview';
	...
	//
	function cmodulos_plantilla_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('modulos');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('modulos', 'x_plantilla');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				...
				if (trim(strval($this->Recordset->fields('plantilla'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $this->Recordset->fields('plantilla'));
				}
				$objBinary->Value = $this->Recordset->fields('plantilla');
