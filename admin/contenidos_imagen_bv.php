...
// Create page object
$contenidos_imagen_blobview = new ccontenidos_imagen_blobview();
$Page =& $contenidos_imagen_blobview;

// Page init
$contenidos_imagen_blobview->Page_Init();

// Page main
$contenidos_imagen_blobview->Page_Main();
?>
<?php
$contenidos_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ccontenidos_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'contenidos_imagen_blobview';
	...
	//
	function ccontenidos_imagen_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('contenidos');
