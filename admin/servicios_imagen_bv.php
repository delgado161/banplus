...
// Create page object
$servicios_imagen_blobview = new cservicios_imagen_blobview();
$Page =& $servicios_imagen_blobview;

// Page init
$servicios_imagen_blobview->Page_Init();

// Page main
$servicios_imagen_blobview->Page_Main();
?>
<?php
$servicios_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cservicios_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'servicios_imagen_blobview';
	...
	//
	function cservicios_imagen_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('servicios');
