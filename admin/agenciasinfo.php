...
//
// Table class for agencias
//
class cagencias {
	var $TableVar = 'agencias';
	...
	function cagencias() {
		...
		// id_agencias
		$this->id_agencias = new cField('agencias', 'agencias', 'x_id_agencias', 'id_agencias', '`id_agencias`', 3, -1, FALSE, '`id_agencias`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_agencias->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_agencias'] =& $this->id_agencias;
		...
		$this->fields['telef_1'] =& $this->telef_1;

		// horario_agencia
		$this->horario_agencia = new cField('agencias', 'agencias', 'x_horario_agencia', 'horario_agencia', '`horario_agencia`', 201, -1, FALSE, '`horario_agencia`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['horario_agencia'] =& $this->horario_agencia;

		// horario_taq_auto
		$this->horario_taq_auto = new cField('agencias', 'agencias', 'x_horario_taq_auto', 'horario_taq_auto', '`horario_taq_auto`', 200, -1, FALSE, '`horario_taq_auto`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['horario_taq_auto'] =& $this->horario_taq_auto;
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `agencias` ($names) VALUES ($values)";
	}
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `agencias` WHERE ";
		$SQL .= ew_QuotedName('id_agencias') . '=' . ew_QuotedValue($rs['id_agencias'], $this->id_agencias->FldDataType) . ' AND ';
	...
	function KeyFilter() {
		...
		if (!is_numeric($this->id_agencias->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@id_agencias@", ew_AdjustSql($this->id_agencias->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("agenciasview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "agenciasadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("agenciasdelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->id_agencias->CurrentValue)) {
			$sUrl .= "id_agencias=" . urlencode($this->id_agencias->CurrentValue);
		} else {
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=agencias" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["id_agencias"]; // id_agencias
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->id_agencias->CurrentValue = $key;
   ...
   // Common render codes
		...
		$this->id_agencias->ViewValue = $this->id_agencias->CurrentValue;
		$this->id_agencias->ViewCustomAttributes = "";
		...
		if (strval($this->id_ciudad->CurrentValue) <> "") {
			$sFilterWrk = "`id_ciudad` = " . ew_AdjustSql($this->id_ciudad->CurrentValue) . "";
		...
		if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
			...
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				$this->id_ciudad->ViewValue = $rswrk->fields('nombre');
				$rswrk->Close();
			} else {
		...
		// horario_agencia
		$this->horario_agencia->ViewValue = $this->horario_agencia->CurrentValue;
		$this->horario_agencia->ViewCustomAttributes = "";

		// horario_taq_auto
		$this->horario_taq_auto->ViewValue = $this->horario_taq_auto->CurrentValue;
		$this->horario_taq_auto->ViewCustomAttributes = "";
		...
		// id_agencias
		$this->id_agencias->LinkCustomAttributes = "";
		$this->id_agencias->HrefValue = "";
		$this->id_agencias->TooltipValue = "";
		...
		$this->telef_1->HrefValue = "";
		$this->telef_1->TooltipValue = "";

		// horario_agencia
		$this->horario_agencia->LinkCustomAttributes = "";
		$this->horario_agencia->HrefValue = "";
		$this->horario_agencia->TooltipValue = "";

		// horario_taq_auto
		$this->horario_taq_auto->LinkCustomAttributes = "";
		$this->horario_taq_auto->HrefValue = "";
		$this->horario_taq_auto->TooltipValue = "";
