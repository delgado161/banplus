...
// Create page object
$documentos_documento_blobview = new cdocumentos_documento_blobview();
$Page =& $documentos_documento_blobview;

// Page init
$documentos_documento_blobview->Page_Init();

// Page main
$documentos_documento_blobview->Page_Main();
?>
<?php
$documentos_documento_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cdocumentos_documento_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'documentos_documento_blobview';
	...
	//
	function cdocumentos_documento_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('documentos');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('documentos', 'x_documento');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				...
				$objBinary->Value = $this->Recordset->fields('documento');
