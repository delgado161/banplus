...
// Create page object
$memoria_semestral_archivo_blobview = new cmemoria_semestral_archivo_blobview();
$Page =& $memoria_semestral_archivo_blobview;

// Page init
$memoria_semestral_archivo_blobview->Page_Init();

// Page main
$memoria_semestral_archivo_blobview->Page_Main();
?>
<?php
$memoria_semestral_archivo_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cmemoria_semestral_archivo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'memoria_semestral_archivo_blobview';
	...
	//
	function cmemoria_semestral_archivo_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('memoria_semestral', 'x_archivo');
