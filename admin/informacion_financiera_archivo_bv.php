...
// Create page object
$informacion_financiera_archivo_blobview = new cinformacion_financiera_archivo_blobview();
$Page =& $informacion_financiera_archivo_blobview;

// Page init
$informacion_financiera_archivo_blobview->Page_Init();

// Page main
$informacion_financiera_archivo_blobview->Page_Main();
?>
<?php
$informacion_financiera_archivo_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cinformacion_financiera_archivo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'informacion_financiera_archivo_blobview';
	...
	//
	function cinformacion_financiera_archivo_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('informacion_financiera');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('informacion_financiera', 'x_archivo');
