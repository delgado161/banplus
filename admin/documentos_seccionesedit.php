...
// Create page object
$documentos_secciones_edit = new cdocumentos_secciones_edit();
$Page =& $documentos_secciones_edit;

// Page init
$documentos_secciones_edit->Page_Init();

// Page main
$documentos_secciones_edit->Page_Main();
?>
...
// Create page object
var documentos_secciones_edit = new ew_Page("documentos_secciones_edit");

// page properties
documentos_secciones_edit.PageID = "edit"; // page ID
documentos_secciones_edit.FormID = "fdocumentos_seccionesedit"; // form ID
var EW_PAGE_ID = documentos_secciones_edit.PageID; // for backward compatibility

// extend page with ValidateForm function
documentos_secciones_edit.ValidateForm = function(fobj) {
...
documentos_secciones_edit.Form_CustomValidate =  
...
documentos_secciones_edit.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
documentos_secciones_edit.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $documentos_secciones->TableCaption() ?></p>
<p class="phpmaker"><a href="<?php echo $documentos_secciones->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $documentos_secciones_edit->ShowPageHeader(); ?>
<?php
$documentos_secciones_edit->ShowMessage();
?>
<form name="fdocumentos_seccionesedit" id="fdocumentos_seccionesedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return documentos_secciones_edit.ValidateForm(this);">
<p>
<input type="hidden" name="a_table" id="a_table" value="documentos_secciones">
...
<input type="hidden" name="x_fecha" id="x_fecha" value="<?php echo ew_HtmlEncode($documentos_secciones->fecha->CurrentValue) ?>">
...
<input type="hidden" name="x_id_documentos_secciones" id="x_id_documentos_secciones" value="<?php echo ew_HtmlEncode($documentos_secciones->id_documentos_secciones->CurrentValue) ?>">
<p>
<input type="submit" name="btnAction" id="btnAction" value="<?php echo ew_BtnCaption($Language->Phrase("EditBtn")) ?>">
</form>
<?php
$documentos_secciones_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$documentos_secciones_edit->Page_Terminate();
?>
<?php
...
// Page class
//
class cdocumentos_secciones_edit {
	...
	// Page object name
	var $PageObjName = 'documentos_secciones_edit';
	...
	//
	function cdocumentos_secciones_edit() {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			$documentos_secciones->CurrentAction = $_POST["a_edit"]; // Get action code
			$this->LoadFormValues(); // Get form values

			// Validate form
			if (!$this->ValidateForm()) {
				$documentos_secciones->CurrentAction = ""; // Form error, reset action
				$this->setFailureMessage($gsFormError);
				$documentos_secciones->EventCancelled = TRUE; // Event cancelled
				$this->RestoreFormValues();
			}
		} else {
			$documentos_secciones->CurrentAction = "I"; // Default action is display
		}

		// Check if valid key
		if ($documentos_secciones->id_documentos_secciones->CurrentValue == "")
			$this->Page_Terminate("documentos_seccioneslist.php"); // Invalid key, return to list
		switch ($documentos_secciones->CurrentAction) {
			case "I": // Get a record to display
				...
				break;
			Case "U": // Update
				$documentos_secciones->SendEmail = TRUE; // Send email on update success
		...
		// Render the record
		$documentos_secciones->RowType = EW_ROWTYPE_EDIT; // Render as Edit
	...
	function LoadFormValues() {
		...
		if (!$documentos_secciones->id_documentos_secciones->FldIsDetailKey)
