...
// Create page object
$banner_imagen_blobview = new cbanner_imagen_blobview();
$Page =& $banner_imagen_blobview;

// Page init
$banner_imagen_blobview->Page_Init();

// Page main
$banner_imagen_blobview->Page_Main();
?>
<?php
$banner_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cbanner_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'banner_imagen_blobview';
	...
	//
	function cbanner_imagen_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('banner');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('banner', 'x_imagen');
