...
// Create page object
$promociones_imagen_blobview = new cpromociones_imagen_blobview();
$Page =& $promociones_imagen_blobview;

// Page init
$promociones_imagen_blobview->Page_Init();

// Page main
$promociones_imagen_blobview->Page_Main();
?>
<?php
$promociones_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cpromociones_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'promociones_imagen_blobview';
	...
	//
	function cpromociones_imagen_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('promociones');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('promociones', 'x_imagen');
