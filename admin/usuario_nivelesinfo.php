...
$usuario_niveles = NULL;

//
// Table class for usuario_niveles
//
class cusuario_niveles {
	var $TableVar = 'usuario_niveles';
	...
	//
	function cusuario_niveles() {
		global $Language;
		$this->AllowAddDeleteRow = ew_AllowAddDeleteRow(); // Allow add/delete row

		// UserLevelID
		$this->UserLevelID = new cField('usuario_niveles', 'usuario_niveles', 'x_UserLevelID', 'UserLevelID', '`UserLevelID`', 3, -1, FALSE, '`UserLevelID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->UserLevelID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['UserLevelID'] =& $this->UserLevelID;

		// nombre
		$this->nombre = new cField('usuario_niveles', 'usuario_niveles', 'x_nombre', 'nombre', '`nombre`', 200, -1, FALSE, '`nombre`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "usuario_niveles_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `usuario_niveles` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `usuario_niveles` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `usuario_niveles` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "usuario_niveleslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("usuario_nivelesview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "usuario_nivelesadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("usuario_nivelesedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("usuario_nivelesadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("usuario_nivelesdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=usuario_niveles" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
