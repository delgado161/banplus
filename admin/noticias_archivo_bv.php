...
// Create page object
$noticias_archivo_blobview = new cnoticias_archivo_blobview();
$Page =& $noticias_archivo_blobview;

// Page init
$noticias_archivo_blobview->Page_Init();

// Page main
$noticias_archivo_blobview->Page_Main();
?>
<?php
$noticias_archivo_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cnoticias_archivo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'noticias_archivo_blobview';
	...
	//
	function cnoticias_archivo_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('noticias', 'x_archivo');
