...
class cuser_levels {
	...
	//
	function cuser_levels() {
		global $Language;
		$this->AllowAddDeleteRow = ew_AllowAddDeleteRow(); // Allow add/delete row

		// UserLevelID
		$this->UserLevelID = new cField('user_levels', 'user_levels', 'x_UserLevelID', 'UserLevelID', '`UserLevelID`', 3, -1, FALSE, '`UserLevelID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->UserLevelID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['UserLevelID'] =& $this->UserLevelID;

		// UserLevelName
		$this->UserLevelName = new cField('user_levels', 'user_levels', 'x_UserLevelName', 'UserLevelName', '`UserLevelName`', 200, -1, FALSE, '`UserLevelName`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `user_levels` ($names) VALUES ($values)";
	}
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `user_levels` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("user_levelsview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "user_levelsadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("user_levelsedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("user_levelsadd.php", $this->UrlParm($parm));
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=user_levels" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
