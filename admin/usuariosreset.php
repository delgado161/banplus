...
<?php if ($usuarios->duracion_pass->Visible) { // duracion_pass ?>
	<tr style='display:none;' id="r_duracion_pass"<?php echo $usuarios->RowAttributes() ?>>
...
<select id="x_duracion_pass" name="x_duracion_pass"<?php echo $usuarios->duracion_pass->EditAttributes() ?>>
	<option selected="selected" value="0">Automático</option>
</select>
...
<input type="submit" name="btnAction" id="btnAction" disabled value="<?php echo ew_BtnCaption($Language->Phrase("EditBtn")) ?>"/>
...
class cusuarios_edit {
	...
	function Page_Init() {
		...
		$actual_l = strpos($actual_l,'usuariosreset.php');
