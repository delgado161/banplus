...
//
// Table class for user_level_permissions
//
class cuser_level_permissions {
	var $TableVar = 'user_level_permissions';
	...
	//
	function cuser_level_permissions() {
		global $Language;
		$this->AllowAddDeleteRow = ew_AllowAddDeleteRow(); // Allow add/delete row

		// UserLevelID
		$this->UserLevelID = new cField('user_level_permissions', 'user_level_permissions', 'x_UserLevelID', 'UserLevelID', '`UserLevelID`', 3, -1, FALSE, '`UserLevelID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->UserLevelID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['UserLevelID'] =& $this->UserLevelID;

		// TableName
		$this->zTableName = new cField('user_level_permissions', 'user_level_permissions', 'x_zTableName', 'TableName', '`TableName`', 200, -1, FALSE, '`TableName`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TableName'] =& $this->zTableName;

		// Permission
		$this->Permission = new cField('user_level_permissions', 'user_level_permissions', 'x_Permission', 'Permission', '`Permission`', 3, -1, FALSE, '`Permission`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "user_level_permissions_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `user_level_permissions` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `user_level_permissions` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `user_level_permissions` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "user_level_permissionslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("user_level_permissionsview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "user_level_permissionsadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("user_level_permissionsedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("user_level_permissionsadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("user_level_permissionsdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=user_level_permissions" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
